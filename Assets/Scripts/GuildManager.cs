...
public class GuildManager
{
    ...
    // This cache pretty much only serves this example , 
    // and assumes that entities are uniquely identifiable by EntityId alone, 
    // which isn't technically true. Your data cache will have to be better.
