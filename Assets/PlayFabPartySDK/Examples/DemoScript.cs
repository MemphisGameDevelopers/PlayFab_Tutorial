...
public class DemoScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        playFabMultiplayerManager.OnChatMessageReceived += OnChatReceived;
    }

    private void OnChatReceived(object sender, PlayFabPlayer from, string message, ChatMessageType type)
    {
    ...
    private void OnNetworkJoined(object sender, string networkId)
    {
        ...
        PlayFabMultiplayerManager.Get().SendChatMessageToAllPlayers("Sup");
